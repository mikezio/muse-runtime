...
Browser work is *not* done by generic subagents - it has its own route, because it needs the shared Chromium profile and the login lineage (see [Browser](05-browser.md)):
